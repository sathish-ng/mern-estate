...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      <h1 className='text-3xl font-semibold mb-4 text-slate-800'>About Sathish Estate</h1>

      <p className='mb-4 text-slate-700'>
        Sathish Estate is a leading real estate agency that specializes in helping clients buy, sell, and 
        rent properties in the most desirable neighborhoods. Our team of experienced agents is dedicated 
